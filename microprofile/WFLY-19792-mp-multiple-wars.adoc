...
* https://issues.redhat.com/browse/WFLY-21006[WFLY-21006 - Update Observability docs to discuss multiple deployment]. Covers MP Telemetry and OpenTelemetry.

=== Affected Projects or Components
There are no changes needed in SmallRye or OpenTelemetry components for this effort.
